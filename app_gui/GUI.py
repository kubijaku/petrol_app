...
base_canvas.create_text(440, 50, text="Petrol App", tags="TITLE", font=('Helvetica', int(text_size)))
...
def resizer(e):
    ...
    base_canvas.create_text(int(e.width/2), int(e.height/8), text="Petrol App", tags="TITLE", font=('Helvetica', int(text_size)))
